      ...
      <div className="row min-vh-100">
        <div className="col-md-8 col-lg-6 col-xl-5 d-flex align-items-center">
          <div className="w-100 py-5 px-md-5 px-xl-6 position-relative">
            <div className="mb-5">
              <img className="img-fluid mb-3" src={square} style={{ maxWidth: '12rem' }} />
              <h2>Welcome back</h2>
            </div>
            <form className="form-validate" onSubmit={handleSubmit}>
              <div className="alert">{userErrors ? errMsg(userErrors) : null}</div>
              <div className="alert">{userError ? serverErr(userError) : null}</div>
